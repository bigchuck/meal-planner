...
class ModeState:
    ...
    Attributes:
        ...
        mode_target: Target ID/parameter (workspace ID, date, etc.)
...
class ModeManager:
    ...
    def enter_plan_mode(self, workspace_id: str) -> Tuple[bool, str]:
        """
        Enter plan mode for a workspace.
        
        Args:
            workspace_id: Workspace/candidate ID
