...
class LockCommand(Command):
    ...
    overview_help = (
        ...
        "\n"
        "Usage: lock <subcommand> [args]\n"
        "\n"
        "Subcommands:\n"
        "  include [meal_type|all] <code> [<multiplier>]   Force a food into recommendations\n"
        "  exclude [meal_type|all] <code|pattern>           Block a food from recommendations\n"
        "  remove <code|pattern>                            Remove a lock\n"
        "  list                                             Show active locks\n"
