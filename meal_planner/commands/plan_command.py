...
class PlanCommand(Command):
    ...
    overview_help = (
        ...
        "  move <id> <from> <to>\n"
        "  ins <id> <position> <codes>\n"
        "  setmult <id> <idx> <mult>\n"
        "  invent <meal_name>\n"
        "  copy <source_id> [<dest_id>]\n"
        "  describe <id> \"text\"\n"
        "  rename <from> <to>\n"
        "  report <id> [--recipes] [--nutrients] [--verbose] [--stage]\n"
        "  promote <id> <@HH:MM> [meal] [--force]\n"
        "  discard\n"
        "  history <plan_id>\n"
        "\n"
        "Use 'help plan <subcommand>' for details on one, or 'mode plan' to work in\n"
